      ...
      <ToastContainer />
        <div 
              ...
              >
                  ...
                  <span className='text-black font-semibold text-xl text-center'>SELECT PAYMENT METHOD</span>
                  <form
                  ...
                  >
                      ...
                      <div className='w-full flex items-center py-4 px-6 mb-3 mt-1'>
                        <input name="address" type="radio" value="PayPal or Credit Card"
                        ref = {radioRef}
                        onChange={() => setChecked(true)}
                        />
                        <span className='text-headingColor text-lg ml-2'>PayPal or Credit Card</span>
                      </div>
